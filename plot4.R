...
par(mfrow=c(2,2))
plot(x=subdata$Time,y=subdata$Global_active_power,ylab='Global Active Power',pch='|',xlab='',type='l')
plot(x=subdata$Time,y=subdata$Voltage,ylab='Voltage',pch='|',xlab='datetime',type='l')
...
plot(x=subdata$Time,y=subdata$Global_reactive_power,pch='|',xlab='datetime',type='l')
dev.off()
